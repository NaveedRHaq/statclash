...
import GameButtons1 from './selector1NFL';
import GameButtons2 from './selector2NFL';
import GameButtons3 from './selector3NFL';
const ER1 = [
        ...
        { id: 5, name: "TBD", nextMatchId: 7, startTime: "2024-01-13", state: "PENDING", winner: "Kansas City", participants: [] },
        { id: 6, name: "TBD", nextMatchId: 7, startTime: "2024-01-13", state: "PENDING", winner: "San Francisco", participants: [] },

        { id: 7, name: "TBD", nextMatchId: null, startTime: "2024-01-20", state: "PENDING", winner: "Kansas City", participants: [] },
